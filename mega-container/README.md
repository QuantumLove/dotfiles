...
### Gmail access (gws CLI)

See **[GMAIL-SETUP.md](GMAIL-SETUP.md)** for the one-time Gmail setup: create your own Internal
Google OAuth client, `gws auth login`, then store the credential in 1Password. The container
